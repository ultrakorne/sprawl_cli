...
| [skill-install](features/skill-install/INDEX.md) | `sprawl skill install` — drop the bundled sprawl skill / sprawl-bookkeeper agent into Claude Code or OpenCode and track each copy for refresh. |
